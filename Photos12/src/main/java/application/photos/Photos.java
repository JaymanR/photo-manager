...
public class Photos extends Application implements Serializable {
    ...
    private static final String storeDir = "src/main/resources/application/photos/dat/users";
    ...
    public void startUp(Stage primaryStage) throws IOException{
        ...
        loader.setLocation(getClass().getResource("/application/photos/view/login.fxml"));
